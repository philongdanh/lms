...
| LMS-024 | Leaderboard real-time | FS | 8 | S6 |
...
| LMS-031 | Learning streak | FS | 5 | S7 |
...
| -- | ----- | ---- | ------ |
| LMS-060 | Dark mode | FE | 3 |
| LMS-061 | Offline mode | FS | 13 |
| LMS-062 | Push notifications | FS | 5 |
| LMS-063 | Social login (Google) | FS | 5 |
| LMS-065 | Rewards shop | FS | 8 |
