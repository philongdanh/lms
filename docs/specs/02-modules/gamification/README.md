...
Chi tiết đặc tả cho module Gamification & Rewards - Business Logic.
...
Module quản lý hệ thống phần thưởng, bao gồm Điểm Kinh nghiệm (EXP), Cấp độ,
Badge, và Cửa hàng Phần thưởng để tăng cường sự gắn kết của người dùng.
...
**Actor**: Học viên **Preconditions**: Có đủ số dư Coins. **Main Flow**:

1. Học viên chọn một phần thưởng trong Cửa hàng.
2. Hệ thống kiểm tra số dư.
3. Hệ thống trừ Coins.
4. Hệ thống tạo yêu cầu đổi thưởng (nếu là vật lý) hoặc cấp phần thưởng ngay
   (nếu là ảo).
